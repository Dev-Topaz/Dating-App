...
public class Chat extends Application implements Constants, Parcelable {
    ...
    public Chat(JSONObject jsonData) {
        ...
        try {
            ...
            /* Ghanshyam For Decoding use - StringEscapeUtils.unescapeJava(String text)*/
            this.setLastMessage(StringEscapeUtils.unescapeJava(jsonData.getString("lastMessage")));

            //this.setLastMessage(jsonData.getString("lastMessage")); Ghanshyam
            ...
            this.setVideoCallPolicy(jsonData.getString("videoCallPolicy"));
