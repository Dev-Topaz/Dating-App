...
public class ServicesFragment extends Fragment implements Constants {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mConnectPrompt = rootView.findViewById(R.id.connectPrompt);
        mDisconnectPrompt = rootView.findViewById(R.id.disconnectPrompt);
        mDisconnectBtn = rootView.findViewById(R.id.disconnectBtn);
