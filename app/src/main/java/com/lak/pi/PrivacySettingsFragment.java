...
public class PrivacySettingsFragment extends PreferenceFragmentCompat implements Constants {
    ...
    String videoCallPolicy = "friends";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        RadioGroup rGroup = (RadioGroup) getActivity().findViewById(R.id.radioGroup1);
        RadioButton rb_all = (RadioButton)getActivity().findViewById(R.id.all) ;
        RadioButton rb_friends = (RadioButton)getActivity().findViewById(R.id.friends) ;
        String policy_setting = App.getInstance().getVideoCallPolicy();
        if(policy_setting.equals("friends")){
            videoCallPolicy = "friends";
            rb_friends.setChecked(true);
        }if(policy_setting.equals("anyone")){
            videoCallPolicy = "anyone";
        ...
        rGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
        {
            public void onCheckedChanged(RadioGroup group, int checkedId)
            {
                ...
                if (isChecked)
                {
                    String policy  =checkedRadioButton.getText().toString();
                    if(policy.equals(getString(R.string.only_friends))){
                        videoCallPolicy = "friends";
                    }if(policy.equals(getString(R.string.anyone))){
                    videoCallPolicy = "anyone";
                }
                    App.getInstance().setVideoCallPolicy(videoCallPolicy);
                    saveSettings();
                    //videoCallPolicy = checkedRadioButton;
                }
            }
        });
    ...
    public void saveSettings() {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_SETTINGS_PRIVACY, null,
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (!response.getBoolean("error")) {
                                ...
                                App.getInstance().setVideoCallPolicy(response.getString("videoCallPolicy"));
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("videoCallPolicy", videoCallPolicy);
