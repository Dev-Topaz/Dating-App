...
import com.lak.pi.adapter.AdvancedPeopleListAdapter;
...
import com.lak.pi.view.RangeSeekBar;
...
public class SearchFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    private int sex_orientation = 0, gender = 3, online = 0, photo = 0, pro_mode = 0, age_from = 18, age_to = 105;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mHeaderContainer = rootView.findViewById(R.id.container_header);
        mHeaderText = rootView.findViewById(R.id.headerText);
        mHeaderSettings = rootView.findViewById(R.id.headerSettings);
        ...
        if (queryText.length() == 0) {
            ...
            if (mRecyclerView.getAdapter().getItemCount() == 0) {
                ...
                if (preload) {
                    ...
                    mHeaderText.setText(getText(R.string.label_search_results) + " " + itemCount);
                }
...
//        MenuInflater menuInflater = getActivity().getMenuInflater();
        ...
        if (searchView != null) {
            ...
            searchAutoComplete.setHintTextColor(getResources().getColor(R.color.grey_20));
            searchAutoComplete.setCursorVisible(true);
            searchAutoComplete.setActivated(true);
            searchAutoComplete.setPressed(true);
            searchAutoComplete.setBackgroundColor(R.color.colorPrimary2);
