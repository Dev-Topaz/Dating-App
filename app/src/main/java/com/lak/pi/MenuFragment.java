...
public class MenuFragment extends Fragment implements Constants {
    ...
    private MaterialRippleLayout mNavProfile, mNavGallery, mNavFriends, mNavMatches, mNavGuests, mNavLikes, mNavLiked, mNavUpgrades, mNavGifts, mNavSettings;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mNavGifts = rootView.findViewById(R.id.nav_gifts);
        ...
        mNavGifts.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {

                Intent i = new Intent(getActivity(), GiftedCoinsActivity.class);
                startActivity(i);
            }
        });
